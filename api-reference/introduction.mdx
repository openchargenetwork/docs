...
| `/payment/request` | POST | Initiate a payment request |
| `/payment/settle` | POST | Submit settlement proof to complete payment |
| `/transfer` | POST | Execute a transfer (banks/settlement providers) |
| `/verify/{txid}` | GET | Verify a transaction |
